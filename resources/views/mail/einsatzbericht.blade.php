...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        table, td { color: #000000; } @media (max-width: 480px) { #u_content_heading_2 .v-text-align { text-align: center !important; } #u_content_text_1 .v-text-align { text-align: center !important; } #u_content_text_3 .v-text-align { text-align: center !important; } }
    </style>
                            ...
                            <div style="height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 40px 0px 50px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
                                    ...
                                    <table id="u_content_heading_2" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 10px 20px;font-family:'Montserrat',sans-serif;" align="left">
                                                ...
                                                <h1 class="v-text-align" style="margin: 0px; color: #000000; line-height: 140%; text-align: left; word-wrap: break-word; font-family: 'Cabin',sans-serif; font-size: 31px; "><strong>Einsatzbericht<br /></strong></h1>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:20px 10px 10px 20px;font-family:'Montserrat',sans-serif;" align="left">
                                                ...
                                                <div class="v-text-align" style="font-size: 20px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                    <p style="line-height: 140%;"><strong>Feuerwehr Dotzheim<br /></strong></p>
                                                </div>
                                    ...
                                    <table id="u_content_text_3" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 20px 10px;font-family:'Montserrat',sans-serif;" align="left">

                                                <div class="v-text-align" style="font-size: 13px; color: #000000; line-height: 160%; text-align: justify; word-wrap: break-word;">
                                                    <div style="line-height: 160%; margin-top: 30px;">

                                                        <!-- BERICHTTEXT //-->
                                                        <div class="v-text-align" style="font-size: 16px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                            <p style="line-height: 140%; font-size: 20px;"><strong>Einsatzmittel und Besatzung<br /></strong></p><br>
                                                        </div>
                                                        @foreach($einsatzmittel as $em)
                                                            <p style="font-weight: bold;">{{ $em->fmsname }} ( {{ $em->name }} )</p>
                                                            <hr>
                                                            @if(!$personalBerichts->where('einsatzmittel',$em->cis_row_id)->count())
                                                               <p> - kein Personal - </p>
                                                            @endif
                                                        ...
                                                        <br>
                                                        <div class="v-text-align" style="font-size: 16px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                            <p style="line-height: 140%; font-size: 20px;"><strong>Bericht<br /></strong></p><br>
                                                            @foreach($berichtTexts as $text)
                                                                <p style="font-weight: bold;">{{ $text->title }}</p>
                                                                <hr>
                                                                <p>
                                                                    {!! nl2br($text->text) !!}
                                                                </p>
                                                        ...
                                                        <div class="v-text-align" style="font-size: 16px; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                            <p style="line-height: 140%; font-size: 20px;"><strong>Dokumentation Atemschutz<br /></strong></p><br>
                                                        </div>
                                                        @if(!$personalBerichts->where('pa_nr','!=',null)->count())
                                                            <p>- kein Einsatz unter Atemschutz dokumentiert -</p>
                                                        @else
                                                            @foreach($personalBerichts->where('pa_nr','!=',null) as $personal)
                                                                <p>
                                                                    +++ {{ $users->where('cis_row_id',$personal->user)->first()->fullname() }} +++
                                                                </p>
                                        ...
                                        <tr>
                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Montserrat',sans-serif;" align="left">
                                                ...
                                                <div class="v-text-align" style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                    <p style="line-height: 140%;">Mit freundlichen Grüßen</p>
                                                    <p style="line-height: 140%;">Freiwillige Feuerwehr Wiesbaden-Dotzheim</p>
                                                    <p style="line-height: 140%;"> </p>
                                                    <p style="line-height: 140%;"> </p>
                                                    <p style="line-height: 140%;"><em>Diese E-Mail enthält vertrauliche und/oder rechtlich geschützte Informationen.</em></p>
                                                    <p style="line-height: 140%;"><em>Wenn Sie nicht der richtige Adressat sind, oder diese E-Mail irrtümlich erhalten haben, informieren Sie bitte den Absender und löschen Sie diese Mail. Das unerlaubte Kopieren sowie die unbefugte Weitergabe dieser E-Mail und der darin enthaltenen Informationen sind nicht gestattet.</em></p>
                                                </div>
